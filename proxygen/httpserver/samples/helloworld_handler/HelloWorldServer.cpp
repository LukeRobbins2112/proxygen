...
class HelloWorldHandlerFactory : public RequestHandlerFactory {
public:
...
int main(int argc, char* argv[]) {
    ...
    std::vector<HTTPServer::IPConfig> IPs = {
            // FLAGS_ip / FLAGS_http_port are gflags
            // could set via command line, or else it will use the default defined above
    ...
    options.handlerFactories = RequestHandlerChain()
            .addThen<HelloWorldHandlerFactory>()
            .build();
